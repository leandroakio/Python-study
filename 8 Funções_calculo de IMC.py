...
while valid_peso == False:
    ...
    try:
        ...
        if peso <=0 or peso > 350:
            print('Peso inválido. Número não pode ser 0 ou negativo e deve ser inferior à 350.')
        else:
            valid_peso = True
            print('\n')
    except:
...
while valid_altura == False:
    ...
    try:
        altura = float(altura)
        if altura <=0.1 or altura > 3:
            print('Altura inválida. Número não pode ser 0 ou negativo e deve ser inferior à 3 metros.')
        else:
            valid_altura = True
            print('\n')
    except:
